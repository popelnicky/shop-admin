export default class TempRangePicker {
    $element = null;
    $subElements = {};
    selectingFrom = true;
    selected = {
    ...
    get template () {
      const from = TempRangePicker.formatDate(this.selected.from);
      const to = TempRangePicker.formatDate(this.selected.to);
    ...
    onRangePickerCellClick(target) {
      ...
      if (value) {
        ...
        if (this.selected.from && this.selected.to) {
          this.dispatchEvent();
          this.close();
          this.$subElements.from.innerHTML = TempRangePicker.formatDate(this.selected.from);
          this.$subElements.to.innerHTML = TempRangePicker.formatDate(this.selected.to)
        }
      }
    }
